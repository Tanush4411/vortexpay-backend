...
import com.chrizlove.vortexpay.api_gateway_service.client.ApiKeyLookupClient;
import com.chrizlove.vortexpay.common_lib.cache.ApiKeyCache;
import com.chrizlove.vortexpay.common_lib.cache.ApiKeyCacheEntry;
import com.chrizlove.vortexpay.common_lib.exceptions.RateLimitException;
import com.chrizlove.vortexpay.common_lib.ratelimit.RateLimitResult;
...
public class ApiKeyAuthHandler {
    ...
    public Map<String, String> authenticate(String authHeader, HttpServletResponse response) {
        ...
        return Map.of(
                ...
                "X-Environment", entry.apiEnvironment().name(),
