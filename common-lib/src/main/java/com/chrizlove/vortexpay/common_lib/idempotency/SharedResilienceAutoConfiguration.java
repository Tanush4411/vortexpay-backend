...
import com.chrizlove.vortexpay.common_lib.cache.ApiKeyCache;
import com.chrizlove.vortexpay.common_lib.cache.RedisApiKeyCache;
import com.chrizlove.vortexpay.common_lib.context.MerchantContext;
import com.chrizlove.vortexpay.common_lib.ratelimit.FixedWindowRateLimiter;
import com.chrizlove.vortexpay.common_lib.ratelimit.RateLimiter;
import com.chrizlove.vortexpay.common_lib.ratelimit.SlidingWindowRateLimiter;
...
public class SharedResilienceAutoConfiguration {
    ...
    public RateLimiter slidingdWindowRateLimiter(StringRedisTemplate stringRedisTemplate) {
