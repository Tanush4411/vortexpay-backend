...
public record ErrorResponse(
    ...
    public static ErrorResponse error(String errorCode, String errorDescription) {
        return new ErrorResponse(errorCode, errorDescription, LocalDateTime.now(), null);
    }

    public static ErrorResponse error(String errorCode, String errorDescription, List<FieldError> fieldErrors) {
